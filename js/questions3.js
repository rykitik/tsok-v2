const questions = [
{
  ...
  correct: [{'Резец': 'img6'}, {'Фреза': 'img7'}, {'Сверло':'img8'}, {'Метчик':'img9'}, {'Плашка': 'img10'}],
  cost: 100,
},
{
  id: 1,
  ...
  correct: [{'Станочное приспособление': 'img11'}, {'Вспомогательный инструмент': 'img12'}, {'Сборочное приспособление':'img13'}, {'Контрольное приспособление':'img14'}, {'Приспособления для захвата заготовок': 'img15'}],
  cost: 100,
},
{
  id: 2,
  ...
  correct: [{'Микрометр': 'img16'}, {'Штангенциркуль': 'img17'}, {'Нутромер':'img18'}, {'Кронциркуль':'img19'}, {'Штангенглубиномер': 'img20'}],
  cost: 100,
},
{
  id: 3,
  ...
  correct: [{'Токарный станок': 'img1'}, {'Сверлильный': 'img2'}, {'Шлифовальный станок':'img3'}, {'Фрезерный станок':'img4'}, {'Протяжной станок': 'img5'}],
  cost: 150,
},
{
  id: 4,
...
},
{
  ...
  offer: "В качестве материала режущей части применяют: инструментальные углеродистую сталь {0} для сверл, метчиков, плашек, инструментальную легированную сталь {1} для протяжек и фрез; быстрорежущую сталь {2} для обработки вязких, но прочных сталей",
...
}, 
{
  ...
  offer: 'Наиболее технически и экономически подходящее приспособление:<br>• в единичном производстве – {0}<br>• в серийном – {1}<br>• в массовом – {2}',
