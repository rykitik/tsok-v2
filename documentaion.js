const questions = [
  ...
  // Сопоставление с изображением
  {
    id: 0,
    type: "matchingImg",
    question: "<p style=font-size:18px>Укажите фактор, влияющий на выбор технологических приспособлений . <br><br><p style=font-weight:normal;font-size:18px> Кликайте на вариант в верхней и соответствующий ему вариант в нижней строке. <br>Выбранные ответы перемещаются вправо. <br>Верные окрашиваются в зеленый, неверные в красный цвет.<br></br>",
    left: ['Резец','Фреза','Сверло','Метчик'],
    options: ["img6", "img7", "img8", "img9"],
    correct: [{'Резец': 'img6'}, {'Фреза': 'img7'}, {'Сверло':'img8'}, {'Метчик':'img9'}],
  },
  // Сопоставление с изображением + картинка сверху
  {
    id: 2,
    type: "matching",
    question: "<p style=font-size:18px>3.	Установите точность поверхностей 1, 2 и 3 по чертежу. <br><br><p style=font-weight:normal;font-size:18px> Кликайте на вариант в верхней и соответствующий ему вариант в нижней строке. <br>Выбранные ответы перемещаются вправо. <br>Верные окрашиваются в зеленый, неверные в красный цвет.<br><br><div style='width: 100%;display: flex;justify-content: center;'> <img style='width: 100%;' src='../img/3_3/img8.jpg' alt='img7'> </div><br>",
    left: ['Поверхность 1','Поверхность 2','Поверхность 3'],
    options: ["Шероховатость Ra 1,25",
              "Шероховатость Ra 6,3", 
              "Шероховатость Ra 2,5"],
  ...
  // Сопоставление
  {
    id: 11,
    type: "matching",
    question: "кажите фактор, влияющий на выбор технологических приспособлений. <p style=font-weight:normal;font-size:18px> Кликайте на вариант в верхней и соответствующий ему вариант в нижней строке. <br>Выбранные ответы перемещаются вправо. <br>Верные окрашиваются в зеленый, неверные в красный цвет.<br></br>",
    left: ['1 условие','2 условие ','3 условие'],
    options: ["",
              "", 
              ""],
